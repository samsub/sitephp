...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 08 Novembre 2017 à 14:18
...
--
-- Structure de la table `itemmenu`
--
...
CREATE TABLE `itemmenu` (
  ...
  `noordre` int(11) NOT NULL,
  `rubriqueid` int(11) DEFAULT '0',
  `itempere` int(11) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Contenu de la table `itemmenu`
--

INSERT INTO `itemmenu` (`itemmenuid`, `Nom`, `type`, `noordre`, `rubriqueid`, `itempere`) VALUES
(1, 'Accueil', 2, 1, 0, 0),
(2, 'News', 2, 1, 10, 1),
(3, 'Tarifs et inscriptions', 1, 2, 1, 0);
...
INSERT INTO `news` (`newsid`, `titre`, `auteur`, `datepublication`, `etatpublication`, `contenu`) VALUES
(1, 'Première news', 0, '2017-11-01', 1, '<p>Première news</p><p><br></p><p>Hé ouais!<br></p>'),
(2, 'test', 2, '2017-11-01', 0, '<p>erere<br></p>');
...
(8, 'Infos pratiques', '', '<p>Infos pratiques</p><p><br></p><p><br></p><table class="table table-bordered"><tbody><tr><td>hkh</td><td>hjkh</td><td>yhkjk</td></tr></tbody></table><p><br></p>'),
...
--
-- AUTO_INCREMENT pour la table `itemmenu`
--
ALTER TABLE `itemmenu`
  MODIFY `itemmenuid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `rubrique`
  MODIFY `rubriqueid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
